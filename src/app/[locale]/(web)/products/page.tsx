...
const Products = () => {
  ...
  return (
    <Box
      variant="row"
      className=" bg-background flex-wrap overflow-hidden pb-10"
    >
          ...
          items={[
            {
              label: 'Cars',
              arLabel: 'السيارات',
              // No href since this is the current page
            },
          ]}
          variant="default"
          separator="default"
      ...
      <Box className="" variant="center"></Box>
