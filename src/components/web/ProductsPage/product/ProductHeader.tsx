    ...
    return (
        <Box variant="center" className='w-full shadow-xl pt-3 pb-3  bg-white'>
            <Box variant="container">
                    <Box variant="rowBetween" className='justify-between items-center xs:flex-wrap '>
                        <Box className='justify-center items-center ' variant="center">
                            <Text variant="mid" className='pr-2 pl-2'> {productName}</Text>
                        </Box>

                        <Box className='justify-center items-center md:flex-nowrap xs:flex-wrap' variant="row">
