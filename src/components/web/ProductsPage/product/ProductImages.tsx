    ...
    return (
        <Box variant="center" className="w-full">
            <Box variant="container">
                <Box variant="row" className='w-full items-start xs:justify-center  gap-2 lg:flex-nowrap xs:flex-wrap'>
                    ...
                    <Box variant="center" className='relative lg:w-[50%]' >
                    ...
                    <Box variant="row" className='flex-wrap justify-start xs:justify-center w-[320px]  xs:w-[100%]'>
                        {/* Image */}
                            <Image 
                        ...
                        <Box className='relative  gap-0 '>
                                ...
                                {/* Overlay */}
                                <div className="absolute top-0 left-0 w-[110px]   h-full bg-black opacity-50 rounded-md"></div>
