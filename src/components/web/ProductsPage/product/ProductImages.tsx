    ...
    return (
        <Box variant="center" className="w-full">
            <Box variant="container">
                <Box variant="row" className='w-full items-start xs:justify-center gap-8 lg:flex-nowrap xs:flex-wrap'>
                    <Box className='xs:w-[90%]'>
                        <Image 
                    ...
                    <Box variant="center" className='relative ' >
                        <Box variant="column" className="items-start xs:w-[90%] ">
                            <Box className='relative  gap-0 xs:w-full'>
                                ...
                                {/* Overlay */}
                                <div className="absolute top-0 left-0 xs:w-full w-[300px] h-full bg-black opacity-50 rounded-md"></div>
                                
                            <Box variant="column" className='justify-center items-center  '>
                    ...
                    <Box variant="row" className='flex-wrap justify-center w-[320px]  xs:w-[100%]'>
                        {/* Image */}
                            <Image 
                        ...
                        <Box className='relative  gap-0 '>
                                ...
                                {/* Overlay */}
                                <div className="absolute top-0 left-0 w-[150px]   h-full bg-black opacity-50 rounded-md"></div>
