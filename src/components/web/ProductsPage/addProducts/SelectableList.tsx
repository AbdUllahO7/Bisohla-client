        ...
        <Box className="min-w-[250px] px-5 py-5" variant="column">
            ...
            <Box variant="column" className="border border-gray-200 px-5 rounded-lg">
                <Box className="mt-4 mb-4 flex items-center gap-2">
                    ...
                    <Button className="bg-primary-foreground text-primary">{direction === "ltr" ? "Add" : "إضافة"}</Button>
                </Box>
                    ...
                    <Box variant="column" className="w-full">
                        {options.map((option) => (
                            <Button
                                ...
                                className={`w-full py-6 px-4 text-primary bg-white font-semibold border-b border-b-gray-200 ${selectedValue === option.value ? "bg-primary-foreground text-primary" : ""}`}
                            >
