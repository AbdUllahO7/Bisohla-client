...
const CardAds = ({ isRent }: { isRent: boolean }) => {
  ...
  return (
    <Box variant="column" className="flex flex-col justify-center items-center ">
      <Card className={`${isRent ? 'max-h-[410px] h-[410px] min-h-[410px]' : 'max-h-[350px] h-[350px] min-h-[350px]'}  border-none rounded-t-[10px] text-center flex flex-col justify-center items-center bg-primary-light `}>
