...
import { useUploadSingleImage } from './use-actions';
import { UploadSingleImageDto } from '@/core/entities/models/file-manager/upload.dto';
            ...
            <AnimatePresence>
              {imageUrls.length > 0 && (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                  className={cn(
                    'grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mt-6 w-full',
                    previewClassName,
                  )}
                >
                  <AnimatePresence>
